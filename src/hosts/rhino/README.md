...
Host adapter for `rhino-mcp`. It wires the Rhino plugin boundary, lifecycle commands, runtime
announcements, update prefix, and typed RhinoCommon/Grasshopper MCP tools.
...
Connect/Disconnect/Status/Update lifecycle commands, runtime announcements, and the
